...
namespace QLNT.Models.EF
{
    public partial class QLNTContext : DbContext
    {
        ...
        public virtual DbSet<AnhMoPhan> AnhMoPhans { get; set; } = null!;
        public virtual DbSet<AnhNghiaTrang> AnhNghiaTrangs { get; set; } = null!;
        public virtual DbSet<DiaChi> DiaChis { get; set; } = null!;
        public virtual DbSet<LietSy> LietSies { get; set; } = null!;
        public virtual DbSet<NghiaTrang> NghiaTrangs { get; set; } = null!;
